import { LuBookMarked, LuBookmark, LuGlobe, LuGlobe2, LuBike } from "react-icons/lu";
...
export const headerNavigation = [
    {
        name: "Programas de estudio", href: "/programas-de-estudio", current: false, isExternal: false, subNavigation: [
            ...
            { name: "Posgrados", href: "/programas-de-estudio/posgrados", current: false, isExternal: true, icon: LuBookmark },
            { name: "Educación continua", href: "/programas-de-estudio/educacion-continua", isExternal: false, current: false, icon: LuGlobe },
    ...
    { name: "Calendario", href: "/calendario", current: false, isExternal: true, subNavigation: [] },
];
...
export const servicesNavigation = [
    ...
    { name: "DEADV", href: "http:/localhost:5173/deavb", current: false, isExternal: true, icon: "https://deadv.uta.edu.ec/images/2020/01/22/deadv-rojo.png" },
